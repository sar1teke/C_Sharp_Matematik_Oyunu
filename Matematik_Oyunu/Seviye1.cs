...
namespace Matematik_Oyunu
{
    public partial class Seviye1 : Form
    {
        ...
        int soruno = 0, dogru, yanlis, passayisi = 0;
        String a;
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            if (soruno == 1)
            {
                ...
                button5.Text = "Seviye 1 İkinci Kısım";
            }
            ...
            if (soruno == 2)
            {
                ...
                button5.Text = "Seviye 1 Üçüncü Kısım";
            }
            ...
            if (soruno == 3)
            {
                ...
                button5.Text = "Seviye 1 Dördüncü Kısım";
            }
            ...
            if (soruno == 4)
            {
                ...
                button5.Text = "Seviye 1 Beşinci Kısım";
            }
