...
{
    public partial class Seviye5 : Form
    {
        public Seviye5()
        {
            InitializeComponent();
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            if (soruno == 1)
            {
                ...
                button5.Text = "Seviye 5 İkinci Kısım";
            }
            ...
            if (soruno == 2)
            {
                ...
                button5.Text = "Seviye 5 Üçüncü Kısım";
            }
            ...
            if (soruno == 3)
            {
                ...
                button5.Text = "Seviye 5 Dördüncü Kısım";
            }
            ...
            if (soruno == 4)
            {
                ...
                button5.Text = "Seviye 5 Beşinci Kısım";
            }
